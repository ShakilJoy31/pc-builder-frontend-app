// Production URL
export const BASE_URL = 'https://pc-builder-application-backend.onrender.com';
// Development URL
// export const BASE_URL = 'http://localhost:6869';
...
export const FORGET_URL = '/customer/forget-password'
export const RESET_URL = '/customer/reset-password'
export const routeCustomer = '/customer';
